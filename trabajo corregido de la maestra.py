...
edad.grid(row=1, column=0, columnspan=2, pady=10)
#  crear una etiqueta
etiq_edad = tk.Entry(ventana, width=40)
etiq_edad.grid(row=0, column=1, padx=5, pady=10)
edad=tk.Entry(ventana,width=40)
edad.grid(row=1, column=0, columnspan=2, pady=10)
# Crear un botón y asignarle la función
boton = tk.Button(ventana, text="dale click", command=mostrar_mensaje)
